...
class TestGameDynamicBehavior(unittest.TestCase):
    ...
    def get_str(self, bot_path, game_str):
        # Read the bot file
        with open(bot_path, "r") as f:
            bot_content = f.read()

        # Read the game file
        with open(game_str, "r") as f:
            game_content = f.read()
        return bot_content, game_content

    def test_invalid_move_return_type(self):
        bot_str = "docker/tests/sample_bots/game_match/invalid_move_type.py"
        game_str = "docker/src/two_player_games/games/Pick.py"

        bot_str, game_str = self.get_str(bot_str, game_str)
...
class TestGameMatchingValidator(unittest.TestCase):
    ...
    def test_validate_successful(self):
        ...
        game_str = "docker/src/two_player_games/games/morris.py"
        bot_str, game_str = self.get_str(bot_str, game_str)
        # Initialize Validator
        validator = BotValidationManager(bot_str, game_str)
    ...
    def test_no_bot_class_found(self):
        ...
        game_str = "docker/src/two_player_games/games/connect_four.py"
        bot_str, game_str = self.get_str(bot_str, game_str)
        # Initialize Validator
        validator = BotValidationManager(bot_str, game_str)
    ...
    def test_multiple_bot_classes_found(self):
        ...
        game_str = "docker/src/two_player_games/games/dots_and_boxes.py"
        bot_str, game_str = self.get_str(bot_str, game_str)
        # Initialize Validator
        validator = BotValidationManager(bot_str, game_str)
    ...
    def test_invalid_get_move_signature_too_many_args(self):
        ...
        game_str = "docker/src/two_player_games/games/nim.py"
        bot_str, game_str = self.get_str(bot_str, game_str)
        # Initialize Validator
        validator = BotValidationManager(bot_str, game_str)
